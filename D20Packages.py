from D20REF_Packages import D20REF_mathing as mathing, D20REF_greet as greet

print(greet.greet_person("A", "Szeto"))
print(mathing.add_numbers(5, 1, 3, 4, 9428))

"""
Packages to check out later:
Database
